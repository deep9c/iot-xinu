...
/* in file receive.c */
extern  int bufPushBack(msg_buf*, const umsg32 *);
extern 	int bufPopFront(msg_buf*, umsg32 *);
...
/* in file event.c */
extern syscall subscribe(topic16 topic, void (*handler)(topic16, void*, uint32));
extern syscall unsubscribe(topic16 topic);
extern syscall publish(topic16 topic, void*, uint32);
/* in file shell.c */
